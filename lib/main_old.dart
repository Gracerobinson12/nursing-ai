...
//       home: FutureBuilder<SettingsModel?>(                    // ← replaces `home: const WelcomeScreen()`
...
//           // No saved settings → first launch, show onboarding
//           if (settings == null) {
...
//                   AppRepository().saveSettings(SettingsModel(
//                     motherName:  widget.motherName,
//                     babyGender:  widget.babyGender,
//                     dueDate:     widget.dueDate.toIso8601String(),
//                     themeColor:  widget.themeColor.value, // Color → int
//                   ));
...
//                 ? () async {                                         // ← add async
//                     await AppRepository().saveSettings(             // ← save before navigating
//                       SettingsModel(
//                         motherName: widget.motherName,
//                         babyGender: widget.babyGender,
//                         dueDate:    widget.dueDate.toIso8601String(),
...
//   // (keep same constructor and fields)
//   @override
...
//     final goals    = await AppRepository().getGoalsForDate(today);
